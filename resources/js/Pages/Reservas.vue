<template>
  <div class="min-h-screen bg-gray-50 text-dark font-sans flex flex-col">
    ...
    <!-- Main content -->
    <main class="flex flex-col md:flex-row justify-between max-w-6xl mx-auto w-full px-6 md:px-0 space-y-10 md:space-y-0 md:space-x-10">
      <!-- Formulário -->
      ...
      <aside class="w-full md:w-1/3 bg-white rounded-lg shadow-md p-6 self-start">
        ...
        <div class="flex items-center mb-4 space-x-3 border-b pb-4">
          <img src="/images/casa1.jpg" alt="Alojamento" class="w-16 h-16 rounded object-cover" />
          <div>
            <h4 class="text-sm font-medium text-dark">Casa do Sol</h4>
            <button class="text-xs text-accent hover:underline mt-1">Ver detalhes</button>
          </div>
        </div>
